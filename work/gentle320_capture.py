...
log=root/'gentle320_serial.log';mail=root/'gentle320_commands.txt'
...
(root/'gentle320_capture.pid').write_text(str(os.getpid()))
with log.open('a',encoding='utf-8',buffering=1) as f:
 def host(msg):
  with (root/'gentle320_events.log').open('a',encoding='utf-8') as h:
