...
const uint32_t DECEL_CEILING_SPS2     = 320;    // direct drive: 0.10 rev/s^2 maximum
const uint32_t ASSIST_DECEL_MAX_SPS2  = 320;    // fallbacks must obey the same gentle limit
...
void help() {
  Serial.println(F(
    ...
    "# build: v2-gentle320-20260918; decel320; brake2200; hold1650; tracking-loss latch\n"
