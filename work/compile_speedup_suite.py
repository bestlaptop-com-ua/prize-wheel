...
try:
 for name,sketch in [('speedup_replay',p/'speedup_replay'),('speedup_wheel',p.parent/'prize_wheel_gpt')]:
...
except Exception:(p/'speedup_build.error').write_text(traceback.format_exc())
