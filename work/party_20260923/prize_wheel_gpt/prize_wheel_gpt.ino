...
void trackSyncError() {
  ...
  const float err = fabsf(encDeg - stepDeg);
...
/* ========================================================================== */
void help() {
  Serial.println(F("# build: failop-20260923 (stage 1a: never releases a moving wheel, capture retries, no persisted faults) on forcestop-guard-20260922 PARTY; takeover defaults OFF"));
  Serial.println(F(
