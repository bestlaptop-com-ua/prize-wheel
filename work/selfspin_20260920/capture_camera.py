...
sys.path.insert(0, str(root / "camera_runtime"))
import av
av.logging.set_level(av.logging.PANIC)
dest = root / "camera_evidence"
...
try:
    ...
    for packet in source.demux(streams):
        ...
        if ready_at is None and packet.stream.type == "video":
            ...
            if key_packet_seen:
                ...
                if first_key is not None:
                    ...
                    (dest / (args.name + "_ready.json")).write_text(json.dumps(ready, indent=2), encoding="utf8")
