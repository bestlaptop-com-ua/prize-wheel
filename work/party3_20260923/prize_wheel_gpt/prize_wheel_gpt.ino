...
/* ========================================================================== */
void help() {
  Serial.println(F("# build: party3-20260923 (flash 3: 2.7 A braking, holds through settle drags, SLIP log) on party-20260923 (flash 2: hand-stop alarm, carry, re-push) on failop-20260923 (stage 1a) PARTY; takeover defaults OFF"));
  Serial.println(F(
