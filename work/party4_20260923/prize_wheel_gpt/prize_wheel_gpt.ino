...
const uint16_t CUR_CAPTURE_MA   = 2700;
...
void closeSpin(SpinResult result) {
  ...
  Serial.printf(
      ...
      "attempts=%u anomalies=%u syncErr=%.1f frozen=%u\n",
...
/* ========================================================================== */
void help() {
  Serial.println(F("# build: party4-20260923 (flash 4: catch speed varies per spin 0.40/0.35/0.30/0.25) on party3-20260923 (flash 3: 2.7 A braking, holds through settle drags, SLIP log) on party-20260923 (flash 2: hand-stop alarm, carry, re-push) on failop-20260923 (stage 1a) PARTY; takeover defaults OFF"));
  Serial.println(F(
