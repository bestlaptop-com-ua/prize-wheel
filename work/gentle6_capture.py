...
log=root/'gentle6_serial.log';mail=root/'gentle6_commands.txt'
...
(root/'gentle6_capture.pid').write_text(str(os.getpid()))
with log.open('a',encoding='utf-8',buffering=1) as f:
 def host(msg):
  with (root/'gentle6_events.log').open('a',encoding='utf-8') as h:
