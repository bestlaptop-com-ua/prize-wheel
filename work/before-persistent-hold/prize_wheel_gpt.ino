...
void startDiagnosticCapture() {
  ...
  Serial.println(F("# DIAG armed: 8192 PSRAM samples, PCNT + driver status; dumps after outputs disabled."));
}
...
void help() {
  Serial.println(F(
    ...
    "# build: v2-rattle-diag-20260918; clock fix + extended diagnostics; control unchanged\n"
