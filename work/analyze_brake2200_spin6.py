...
block=blocks[2];header=block.splitlines()[0].strip().split(',');rows=[];bad=0
...
(p/'brake2200_spin6_rattle.log').write_text(text)
with (p/'brake2200_spin6.csv').open('w',newline='') as f:
...
print('saved brake2200_spin6.csv')