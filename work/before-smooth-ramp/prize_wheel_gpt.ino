...
void startDiagnosticCapture() {
  ...
  Serial.println(F("# DIAG armed: 8192 PSRAM samples, PCNT + driver status; includes 5 seconds of hold."));
}
...
void help() {
  Serial.println(F(
    ...
    "# build: v2-hold1650-20260918; 1650mA hold until next spin; STEP clock fixed\n"
