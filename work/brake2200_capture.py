...
log=root/'brake2200_serial.log';mail=root/'brake2200_commands.txt'
...
(root/'brake2200_capture.pid').write_text(str(os.getpid()))
with log.open('a',encoding='utf-8',buffering=1) as f:
 def host(msg):
  with (root/'brake2200_events.log').open('a',encoding='utf-8') as h:
